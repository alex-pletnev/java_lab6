...
public class ExecuteScript {
    private static final int SERVICE_PORT = 50002;
    ...
    public Reply execute() throws CommandException{
        ...
        try (InputStream inputStream = new BufferedInputStream(new FileInputStream((String) getArgList().get(0)))){
            ...
            while (power) {
                try {
                    command = (CommandAbstract) parseCommand(commandManager, scanner);
    ...
    private CommandInterface parseCommand(CommandManager manager, Scanner input) throws NoSuchElementException{
        try {
